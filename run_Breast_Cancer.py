...
adata= train_model.train(adata,k,n_epochs=200,h=[3000,3000],radius=50,l=0.63,lr=0.0000001)
...
sc.pl.spatial(adata, color=["stMMR", "Ground Truth"], title=['stMMR (ARI=%.2f)' % ARI, "Ground Truth"],show=False,
           save=section_id)